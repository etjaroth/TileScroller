...
void Shader::make_shader(const char* shaderPath, GLenum shaderType) {
...
Shader::Shader(const char* vertexPath, const char* fragmentPath) {
	make_shader(vertexPath, GL_VERTEX_SHADER);
	make_shader(fragmentPath, GL_FRAGMENT_SHADER);
...
Shader::Shader(const char* vertexPath, const char* geometryPath, const char* fragmentPath) {
	///*
	make_shader(vertexPath, GL_VERTEX_SHADER);
	make_shader(geometryPath, GL_GEOMETRY_SHADER);
	make_shader(fragmentPath, GL_FRAGMENT_SHADER);
